...
public class gafe_iden {
    ...
    public gafe_iden(int codi_gafe_iden, String nomb_gafe_iden, String nume_tipo_gafe, tipo_gafe codi_tipo_gafe, String fech_alta, String fech_baja, String esta) {
